...
function Navbar() {
  ...
  return (
    <>
        <div className={`max-w-screen-2xl bg-white container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 dark:bg-slate-900 dark:text-white`}>
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer">Movies Library</a>
  </div>
